...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('summary.index')}}">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">M-DIGI</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a href="{{ route('summary.index') }}" class="nav-link {{ request()->is('/') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('report.via_bendahara') }}"
                    class="nav-link {{ request()->is('report-bendahara') ? 'active' : '' }}">
                    <i class="fas fa-solid fa-book"></i>
