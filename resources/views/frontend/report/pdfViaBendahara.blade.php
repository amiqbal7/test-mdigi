        ...
        <table border="1" cellpadding="5" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><strong>{{ number_format(($realizations->sum('total') / $realizations->sum('target')) * 100, 2) }}%</strong>
                    </td>
                </tr>
            </tbody>
        </table>
    @else
        <p>Tidak ada data untuk tahun {{ \Carbon\Carbon::parse($startDate)->format('d-m-Y') }} s/d {{ \Carbon\Carbon::parse($endDate)->format('d-m-Y') }}.</p>
    @endif
</body>
